    ...
    def __compute(self, v :Vehicle):
        ...
        if trafficlight.pos[0] - v.state[0] > -1.5:
            ...
            if trafficlight.pos[0] - v.state[0] < -20.0:
                s.Status = 1
        # s.NrObjs = (barricade.pos[0] - v.state[0]).astype(int)
        # s.ObjLen[0] = (barricade.pos[0] - v.state[0])
        # s.ObjLen[1] = (barricade.pos[1] - v.state[1])
        # s.ObjLen[2] = (barricade2.pos[0] - v.state[0])
        # s.ObjLen[3] = (barricade2.pos[1] - v.state[1])
        
        s.ObjVel[0] = v.state[0]
        s.ObjVel[1] = v.state[1]
        s.ObjVel[2] = v.degree


        s.ObjLen[0] = (barricade.w1/1000)
        s.ObjLen[1] = (barricade2.w1/1000)


        s.ObjWidth[0] = (barricade.h1/1000)
        s.ObjWidth[1] = (barricade2.h1/1000)

        s.ObjX[0] = barricade.pos[0]
        s.ObjX[1] = barricade2.pos[0]
  

        s.ObjY[0] = barricade.pos[1]
        s.ObjY[1] = barricade2.pos[1]
        ...
        # print("Barricade size")
        # print(barricade.w1/1000)
